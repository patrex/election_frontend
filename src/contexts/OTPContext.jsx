...
const OTPVerificationModal = () => {
    ...
    const handleVerifyOtp = useCallback(async (otpOverride = null) => {
        ...
        try {
            const result = await verifyOtpApi(destination, otpToVerify);
...
export const OTPProvider = ({ children }) => {
    ...
    const startVerification = (inputDestination) => {
        return new Promise((resolve, reject) => {
            ...
            } else if (isNigerianPhoneValid(finalDestination)) {
                // Input is a Nigerian phone number, normalize it
                finalDestination = normalizeNigerianPhone(finalDestination);
            } else {
