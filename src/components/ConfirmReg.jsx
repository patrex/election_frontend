...
const VoterCheckOverlay = ({ isOpen, onClose, userAuthType, voters }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-gray-900/70 backdrop-blur-sm flex items-end justify-center"
      onClick={handleClose}
    >
      <div
      ...
      >
        {/* Drag pill */}
        <div className="w-9 h-1 rounded-full bg-gray-300 dark:bg-gray-700 mx-auto mb-5" />
