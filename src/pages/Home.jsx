		...
		<>
			{phoneModalOpen && 
				<div className="modal-overlay">
					<div className="w-5/6 md:w-1/3 lg:w-1/3 xl:w-1/3 p-4 rounded-lg shadow-md relative bg-white">
			...
			{OTPOpen && 
				<div className="modal-overlay">
					<div className="w-5/6 p-4 md:w-1/3 lg:w-1/3 xl:w-1/3 rounded-lg shadow-md relative bg-white">
						<span>{`${election.title}`}</span>
