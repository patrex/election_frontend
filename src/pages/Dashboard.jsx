	...
	return (
		<main className="dashboard-container">
			{elections.length ? (
				...
				<NoData
					image={noDataGraphic}
					message={<>You've not created any elections. <Link to={`/user/${user.id}/create-election`} className="text-indigo-600 hover:text-indigo-800 font-medium">Create one</Link> to continue</>}
				/>
			)}
		</main>
	);
