      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-slate-100">
        ...
        <div className="space-y-3 flex flex-col items-center">
          <button
            ...
            className="w-fit py-3 px-6 bg-white border border-slate-200 hover:bg-blue-100 text-slate-700 rounded-xl font-medium transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
