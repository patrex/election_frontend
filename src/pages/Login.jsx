			...
			<div className="w-full md:w-1/2 flex items-center justify-center p-6">
				<div className="max-w-md w-full">
					...
					<form onSubmit={ handleSubmit(onSubmit) }>
						...
						<button 
							className="w-full px-3 py-2 bg-blue-600 text-white text-center mx-auto block text-lg font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-500 transition duration-200"
							disabled={loading}
